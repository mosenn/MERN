...
const Login = () => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      <Link
        to={`https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=789w0zpn0e11a6&redirect_uri="https://mern-pmfsmihoj-rizemizeeee-gmailcom.vercel.app/accessLinkedin&state=foobar&scope=r_liteprofile%20r_emailaddress%20w_member_social`}
      >
        Login with linkedin
      </Link>
